...
-----------------------------------------------------------------------
*/
#define HS_CMD_ADDR				0x2000004    /* B1 ADDR : ID LCD Command 출력 */
#define	IDLCD_REG_ADDRESS					( * (volatile byte*)( 0x2000004 ) )
#define	HS_DAT_ADDR				0x2000006    /* B1 ADDR : ID LCD Data    출력 */
#define	IDLCD_DATA_ADDRESS				( * (volatile byte*)( 0x2000006 ) )
									
#define	IDLCD_OUTP_CMD( Value )	    outp ( 0x2000004 , (Value) );								
#define	IDLCD_OUTP_DATA( Value )	outp ( 0x2000006 , (Value) );								
